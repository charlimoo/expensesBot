...
class OpenAIHelper:
    ...
    async def get_chat_response(self, chat_id: int, query: str, user_id: int) -> tuple[str, str]:
        """
    ...
    async def get_chat_response_stream(self, chat_id: int, query: str, user_id: int):
        """
    ...
    async def __common_get_chat_response(self, chat_id: int, query: str, stream=False, user_id=None):
        """
    ...
    async def __handle_function_call(self, chat_id, response, stream=False, times=0, plugins_used=(), user_id=None):
        function_name = ''
        arguments = ''
        if stream:
        ...
        # Check if the user_id is already in the arguments_dict

        arguments_dict['user_id'] = user_id
    ...
    async def __common_get_chat_response_vision(self, chat_id: int, content: list, stream=False, user_id=None):
        """
        Request a response from the GPT model.
        :param chat_id: The chat ID
        :param query: The query to send to the model
